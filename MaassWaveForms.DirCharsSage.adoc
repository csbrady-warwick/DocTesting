= Database report for MaassWaveForms\DirCharsSage =
...
a|chars a| collection of integer a| `[0, 0]` a| @@MaassWaveForms\DirCharsSage\chars\description@@
a|Modulus a| integer a| `1` a| @@MaassWaveForms\DirCharsSage\Modulus\description@@
|==============================
...
@@MaassWaveForms\DirCharsSage\(NOTES)\description@@
