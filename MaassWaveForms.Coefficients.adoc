...
a|Numc a| integer a| `5000`
 a| @@MaassWaveForms\Coefficients\Numc\description@@
a|coeff_id a| non-primitive type (<class 'bson.objectid.ObjectId'>) a| `4f7052dc5009fb18ef000811`
 a| @@MaassWaveForms\Coefficients\coeff_id\description@@
|==============================
